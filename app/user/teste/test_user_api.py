...
class PublicUserApiTest(TestCase):
    ...
    def test_create_token_for_user(self):
        payload = {'email':'teste@teste.com', 'password':'ps'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        create_user(email='teste@teste.com', password='ps')
        res = self.client.post(TOKEN_URL, {'email':'teste@teste.com','password':'errado'})
